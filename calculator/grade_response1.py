...
class GradePortal:
    ...
    def get_grades(self, m_id: str) -> List[Dict]:
        ...
        for record in all_records:
            ...
            s_dict[s_id]['scores'].append((t_type, t_per, final_grade))

        final_results = []
        for s_id, learner_data in s_dict.items():
            total_score = sum(final_grade * t_per / 100 for t_type, t_per, final_grade in learner_data['scores'])
